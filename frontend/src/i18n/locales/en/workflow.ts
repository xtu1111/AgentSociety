export default {
    ...
    interview: "Interview",
    interviewTooltip: "Send interview questions to specified agent",
    ...
    targetAgentModeTooltip: "Select target agent input mode",
    ...
    targetAgentIdsTooltip: "Enter agent IDs to interview, separated by commas",
    targetAgentExpression: "Target Agent Expression",
    targetAgentExpressionTooltip: "Use expression to select agents to interview",
    ...
    interviewMessageTooltip: "Enter interview question to send",
    ...
    saveContextTooltip: "Save the context of specified agents",
    saveAs: "Save As",
    saveAsTooltip: "Key identifier for saving the context",
    pleaseEnterSaveAs: "Please enter save as key",
    enterSaveAs: "Enter save as key",
    contextKey: "Context Key",
    contextKeyTooltip: "Key identifier for the context to save",
    ...
    agentClassTooltip: "Select agent class to filter",
    agentClassGroups: {
        citizen: "Citizen",
